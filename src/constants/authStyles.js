...
// version assombrie du survol. Elles étaient écrites en valeurs littérales,
// faute de jetons ; ce n'est plus le cas.
export const AUTH_STYLES = {
  // Inputs
  input: {
    base: "w-full px-4 py-3 bg-gray-100 border-0 rounded-md focus:bg-white focus:ring-2 focus:outline-none transition-all",
    primary: "focus:ring-brand-400",
  ...
  // Boutons
  button: {
    primary: "w-full bg-brand-500 hover:bg-brand-600 text-white font-semibold py-3 px-6 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed",
    ...
    link: "text-brand-500 hover:text-brand-400 font-semibold transition-colors",
  ...
  text: {
    ...
    link: "text-brand-500 hover:text-brand-400 transition-colors"
  },
