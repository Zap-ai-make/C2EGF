 ...
 * le wordmark est « C2EGF BURKINA », le nom PWA « C2EGF », et le thème de marque « c2egf » (bleu marine #173863).
...
describe('TC-092 — branding dérivé du profil', () => {
  it('caractérisation C2EGF (profil réel) → C2EGF BURKINA / C2EGF / c2egf', async () => {
    vi.resetModules()
    const b = await import('../../src/constants/branding.js')
    expect(b.APP_NAME).toBe('C2EGF BURKINA')
